...
| File | Perubahan |
|---|---|
| `src/db/queries/budgets.ts` | Add `getTransactionsForBudget` + `BudgetTxRow` |
| `src/app/(app)/budgets/actions.ts` | Add `getBudgetTransactionsAction` |
| `src/app/(app)/budgets/_components/BudgetDrillSheet.tsx` | New file |
| `src/app/(app)/budgets/_components/BudgetCard.tsx` | Rename onEdit → onTap |
| `src/app/(app)/budgets/_components/BudgetGroup.tsx` | Pass onTap |
| `src/app/(app)/budgets/page.tsx` | Wire drill-down state |
